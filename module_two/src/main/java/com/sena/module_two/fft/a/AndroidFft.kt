...
//
//
//    private val twiddle = longArrayOf(
...
//        return (((a shl 16) * (b shl 16) + a.toShort() * b.toShort()) and 0xFFFF.inv()) or
//            ((((a shl 16) * b.toShort() - a.toShort() * (b shl 16)) shl 16) and 0xFFFF)
//    }
//
//    private fun half(a: Int): Int {
//        return ((a shl 1) and 0x8000.inv()) or (a and 0x8000)
//    }
//
//    fun fixed_fft(n: Int, v: IntArray): IntArray {
//        var scale = 10
//        var i: Int
//        var p: Int
//        var r: Int
...
//            r = 1
//            while (r < p) {
//                var w = (1 shr 10) / 4 - (r shr scale)
//                i = w shl 31
//                w = twiddle[(w xor i) - i].toInt() xor (i shr 16)
//                i = r
//                while (i < n) {
//                    val x = half(v[i])
//                    val y = mult(w, v[i + p])
